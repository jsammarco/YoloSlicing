...
while True:
    ...
    num_slices_x = 4  # Number of horizontal slices
    num_slices_y = 3  # Number of vertical slices
    ...
    results = model.predict(slices_resized, batch=len(slices_resized), imgsz=640, conf=0.4, iou=0.7, retina_masks=True, half=False, vid_stride=15)
